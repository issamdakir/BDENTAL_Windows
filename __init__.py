...
if not exists(BDENTAL_Modules_DIR):
    os.mkdir(BDENTAL_Modules_DIR)
        

if not sys.path[0] == BDENTAL_Modules_DIR :
    sys.path.insert(0, BDENTAL_Modules_DIR)
...
if NotFoundPkgs :
    ...
    from .Operators import BDENTAL_ScanOperators, BDENTAL_MeshesTools_Operators
